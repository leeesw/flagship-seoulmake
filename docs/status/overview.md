...
| Retries (global) | 0 |
| Dead (global) | 5 |
| Error lines (since 1 hour ago) | 418 |
...
| sidekiq-enqueue@reconcile_drip.service | failed | failed | 0 |  |
| sidekiq-enqueue@score_drip.service | failed | failed | 0 |  |
| sidekiq-enqueue@seo_drip.service | failed | failed | 0 |  |

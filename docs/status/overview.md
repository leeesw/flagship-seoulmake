...
| Retries (global) | 141 |
| Dead (global) | 131 |
| Error lines (since 1 hour ago) | 183 |
...
| sidekiq-enqueue@ads_drip.service | activating | start | 2061902 |  |
| sidekiq-enqueue@score_scan.service | inactive | dead | 0 |  |
| sidekiq-enqueue@seo_inc.service | activating | start | 2061903 |  |
